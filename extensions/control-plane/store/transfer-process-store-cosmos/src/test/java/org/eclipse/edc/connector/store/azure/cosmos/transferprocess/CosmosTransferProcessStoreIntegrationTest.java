...
class CosmosTransferProcessStoreIntegrationTest extends TransferProcessStoreTestBase {
    ...
    /**
     * As of June 1, 2023, CosmosDB seems to return the entire collection when sorting on a nonexistent property, instead of returning
     * an empty list. The default behaviour in {@link TransferProcessStoreTestBase} is to expect an empty list, therefor the
